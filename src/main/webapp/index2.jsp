...
<audio id="effect2" src="files/nintendo-game-boy-startup.mp3"></audio>
...
/*             $(window).on('beforeunload', function() {
			...
			/* $("td").click(function() {
                if ($(this).css('background-color') != 'rgba(0, 0, 0, 0.43)') {
                    ...
                    var itemId = $(this).find('.box-item').attr('id');
                    console.log(itemId);
                    $('#' + itemId).toggle();
		            $(this).css('background-color', '#0000006e');
	                ...
	                if(bombPositionValue == itemId) {
		                $('.box-item').show();
 		                ...
 		                $("td").each(function() {
		                    if ($(this).css('background-color') != 'rgba(0, 0, 0, 0.43)') {
		                        $(this).css('background-color', 'rgba(101, 102, 134, 0.5)');
		                    }
		                });
                ...
                console.log('bombPositionValue ' + bombPositionValue);
