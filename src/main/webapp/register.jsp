...
<h:form id="form">
    <section>
        <div class="signin">
            <div class="content">
                <h2>Sign Up</h2>
                    <h:message styleClass="message" for="signup"/>
                <div class="form">
                    <div class="inputBx">
                    ...
                    <div class="inputBx">
                    	<h:commandButton id="signup" action="#{loginImpl.addUser(user)}" value="Login" />
                    </div>

                    <div class="link">
                        <p>Already have an account?</p>&nbsp;<a href="login.jsf">Sign in</a>
                    </div>
